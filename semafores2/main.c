...
int streamer (void* shMemPtr, int semId, char* fileFromName)
{
    ...
    /*
    PRINT ("1-in\n")
    sem_do2 (NO_FOL_STR, 0, 0, NO_FOL_STR, 1, 0)
    PRINT ("2-in\n")
    sem_do2 (NO_STR_STR, 0, 0, NO_STR_STR, 1, 0)
    PRINT ("3-in\n")
    */

    PRINT ("1-in\n")
    dumpSemafores(semId);
    sem_do4 (NO_FOL_STR, 0, 0,
             NO_FOL_STR, 1, 0,
             NO_STR_STR, 0, 0,
             NO_STR_STR, 1, 0)
    PRINT ("2-in\n")
    ...
    /*
    PRINT("1-out\n")
    sem_do(NO_STR_FOL, -1, 0)
    PRINT("2-out\n")
    sem_do(NO_STR_STR, -1, 0)
    PRINT("3-out\n")
    */

    PRINT ("1-out\n")
    dumpSemafores(semId);
    sem_do2 (NO_STR_FOL, -1, 0,
             NO_STR_STR, -1, 0)
    PRINT ("2-out\n")
    dumpSemafores(semId);
...
int follower (void* shMemPtr, int semId)
{
    ...
    /*
    PRINT ("1-in\n")
    sem_do2 (NO_FOL_FOL, 0, 0, NO_FOL_FOL, 1, 0)
    PRINT ("2-in\n")
    sem_do2 (NO_STR_FOL, 0, 0, NO_STR_FOL, 1, 0)
    PRINT ("3-in\n")
    */

    PRINT ("1-in\n")
    dumpSemafores(semId);
    sem_do4 (NO_FOL_FOL, 0, 0,
             NO_FOL_FOL, 1, 0,
             NO_STR_FOL, 0, 0,
             NO_STR_FOL, 1, 0)
    PRINT ("2-in\n")
    ...
    /*
    PRINT("1-out\n")
    sem_do(NO_FOL_FOL, -1, 0)
    PRINT("2-out\n")
    sem_do(NO_FOL_STR, -1, 0)
    PRINT("3-out\n")
    */

    PRINT("1-out\n")
    dumpSemafores(semId);
    sem_do2 (NO_FOL_FOL, -1, 0,
             NO_FOL_STR, -1, 0)
    PRINT("2-out\n")
    dumpSemafores(semId);
...
int dumpSemafores (int semId)
{
    ...
    printf ("NO_STR_STR    = %d\n", semctl(semId, NO_STR_STR   , GETVAL));
    printf ("NO_FOL_STR    = %d\n", semctl(semId, NO_FOL_STR   , GETVAL));
    printf ("NO_STR_FOL    = %d\n", semctl(semId, NO_STR_FOL   , GETVAL));
    printf ("NO_FOL_FOL    = %d\n", semctl(semId, NO_FOL_FOL   , GETVAL));
